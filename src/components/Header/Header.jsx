 ...
 const handleMobileMenu =()=>{
  ...
  return (
    <header className={styles.header}>
      <a className={styles.logo}href="./">Moveis<i><FaHammer/></i></a>
      <div className={styles.containerMenuMobile}>
        {mobile && 
          <button onClick={handleMobileMenu} 
            className={`${styles.buttonMenu} ${mobileMenu && styles.buttonMenuActive}`}>
              {mobileMenu ? <i><IoMdClose/></i> : <i><RxHamburgerMenu/></i>}
          </button>}
